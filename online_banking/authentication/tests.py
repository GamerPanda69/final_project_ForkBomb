...
class AuthenticationViewsTests(TestCase):
    ...
    def test_register_view_post_success(self):
        ...
        form_data = {
            ...
            'password': 'newpassword123', # Use built-in form field names
            'password1': 'newpassword123', # Password field
    ...
    def test_logout_view(self):
        ...
        response = self.client.get(logout_url, follow=True) # Use GET for default LogoutView or POST if required
